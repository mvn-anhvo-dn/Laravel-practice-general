...
Route::get('/search/index', [App\Http\Controllers\SearchController::class, 'index'])->name('users.search');
Route::get('/search', [App\Http\Controllers\SearchController::class, 'search'])->name('users.searchUser');
Route::get('/search/comment', [App\Http\Controllers\SearchController::class, 'searchByComment'])->name('users.searchComment');
Route::get('/search/post', [App\Http\Controllers\SearchController::class, 'searchByPosts'])->name('users.searchPost');
